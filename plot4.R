...
plot4<-function(dir.working = "./", output.file.name="plot4.png", image.width=640, image.height=480){
    ...
    plot(timestamp, ds$Voltage, type="l", xlab="datetime", ylab="Voltage");
    ...
    plot(timestamp, ds$Global_reactive_power, type="l", xlab="datetime");
